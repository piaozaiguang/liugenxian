	    ...
	    <tbody>
	    	<c:forEach items="${paging.list}" var="list">
		    	<tr>
		            ...
		            <td><a class="uk-button uk-button-primary" href="/admin/post/edit/${list.postNo}">编辑</a></td>
		            <td><a class="uk-button uk-button-danger" href="/admin/post/delete/${list.postNo}">删除</a></td>
		        </tr>
	        </c:forEach>
	    </tbody>
	</table>
