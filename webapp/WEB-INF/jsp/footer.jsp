...
<nav class="uk-navbar">
	<div class="uk-container uk-container-center uk-text-center" style="padding:25px 0;">
        <div class="uk-panel">
            ...
            <font class="uk-text-small uk-text-muted">本站吉他谱来源于网络,版权归其所有人所有,仅供交流学习用,如果侵犯了您的权利,请联系我们,我们会尽快处理.</font><br><a target="_blank" rel="license" href="http://creativecommons.org/licenses/by-nc/4.0/"><img alt="知识共享许可协议" style="border-width:0" src="https://i.creativecommons.org/l/by-nc/4.0/88x31.png"></a>
        </div>
    </div>
</nav>